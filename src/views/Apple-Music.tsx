...
const AppleMusic = (props: typeof defaultSong) => {
  const song = {
    ...defaultSong,
    ...props,
  }
  ...
  const snapPoints = useMemo(() => {
    return [initialSnapPoints[0] + bottom, initialSnapPoints[1]]
  }, [bottom])
    ...
    return (
      ...
      >
        <Image
          ...
          source={{
            uri:
              'https://images-na.ssl-images-amazon.com/images/I/71TRfYUtDLL._SL1500_.jpg',
          }}
        />
      </AnimatedView>
    )
  ...
  const renderHeader = () => {
    ...
    return [
      ...
      >
        <AnimatedView style={{ height: snapPoints[0] }}>
          <AnimatedView
            style={[
          ...
          >
            ...
            <View style={styles.songDetailsSmall}>
              ...
              <Text style={styles.artistTitleSmall}>{song.artist}</Text>
            </View>
  ...
  const renderSongItem = ({ item }: { item: any }) => {
    return (
      <TouchableWithoutFeedback
        // onPress={() => console.log('[press song]', item)}
        style={styles.songListItemContainer}
        disabled
      >
        <>
          <View
...
const styles = StyleSheet.create({
  ...
  contentContainer: {
    alignItems: 'center',
    height: initialSnapPoints[1] - initialSnapPoints[0],
    overflow: 'visible',
  },
  ...
  songTitleSmall: {
    ...
    fontSize: 16,
    lineHeight: 16,
    // paddingTop: songCoverSizes[0] / 2 - 8,
    marginBottom: 8,
  },
